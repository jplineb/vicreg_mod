#!/bin/bash
#PBS -N CheX_LPA
##PBS -l select=1:ncpus=40:mem=350gb:ngpus=1:gpu_model=v100,walltime=10:00:00
...
#     --pretrained_path ./VICReg_ImageNet/resnet50.pth \
#     --exp-dir ./checkpoint/mimiccxr_VICReg_ImageNet_LP \
#     --pretrained-how VICReg \
#     --pretrained-dataset ImageNet \
#     --epochs $epochs \
#     --weights $weights \
...
# python evaluate_mimiccxr.py \
#     --pretrained_path ./VICReg_RadImageNet/resnet50.pth \
#     --exp-dir ./checkpoint/mimiccxr_VICReg_RadImageNet_LP \
#     --pretrained-how VICReg \
#     --pretrained-dataset RadImageNet \
#     --epochs $epochs \
#     --weights $weights \
...
# python evaluate_mimiccxr.py \
#     --pretrained_path ./ \
#     --exp-dir ./checkpoint/mimiccxr_ResNet50_ImageNet_LP \
#     --pretrained-how Supervised \
#     --pretrained-dataset ImageNet \
#     --epochs $epochs \
#     --weights $weights \
